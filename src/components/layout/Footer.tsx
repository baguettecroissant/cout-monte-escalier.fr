            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        ...
                        <li><Link href="#" className="text-slate-300 hover:text-white transition-colors text-lg">Mentions Légales</Link></li>
                        <li><Link href="#" className="text-slate-300 hover:text-white transition-colors text-lg">Politique de Confidentialité</Link></li>
                    </ul>
                </div>
