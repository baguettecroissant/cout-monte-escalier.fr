    ...
    return (
        <section className="bg-slate-50 border-b border-slate-200 py-16 lg:py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
                <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-800 px-4 py-2 rounded-full font-medium mb-8">
                    <MapPin className="h-4 w-4" />
                    <span>Installation disponible à {city.name} ({city.zip})</span>
                </div>

                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 tracking-tight">
                    Prix d'un Monte-Escalier à <span className="text-orange-600">{city.name}</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button size="lg" className="bg-orange-600 hover:bg-orange-700 text-white text-lg px-8 h-14 w-full sm:w-auto shadow-lg rounded-full">
