      ...
      <section className="bg-white border-b border-slate-100 py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center md:justify-between items-center gap-6 text-slate-500 text-sm font-medium uppercase tracking-wider">
            <div className="flex items-center gap-2"><Award className="h-5 w-5 text-orange-600" /> Artisans RGE Vérifiés</div>
            <div className="flex items-center gap-2"><Euro className="h-5 w-5 text-orange-600" /> Devis Gratuits sans engagement</div>
            <div className="flex items-center gap-2"><Clock className="h-5 w-5 text-orange-600" /> Réponse sous 48h</div>
            <div className="flex items-center gap-2"><Shield className="h-5 w-5 text-orange-600" /> Éligible MaPrimeAdapt'</div>
          </div>
        </div>
      </section>
